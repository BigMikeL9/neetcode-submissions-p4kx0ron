public class Solution {
    public List<List<string>> GroupAnagrams(string[] strs) {
        ...
        // Time Complexity is O(m * nlogn) where m is the length of strs and n is the length of the longest string
        // Space Complexity is O(m * n) where m is the length of strs and n is the length of the longest string
