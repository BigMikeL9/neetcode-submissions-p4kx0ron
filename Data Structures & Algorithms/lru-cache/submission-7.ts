class TreeNode {
    ...
    constructor(key: number, val: number, next: TreeNode | null, prev: TreeNode) {
        this.key = key;
        this.val = val;
        this.next = next;
        this.prev = prev;
...
class LRUCache {
    ...
    constructor(capacity: number) {
        ...
        this.leftDummy = new TreeNode(null, null, null, null);
        this.rightDummy = new TreeNode(null, null, null, null);
    ...
    put(key: number, value: number): void {
        if (this.hashMap.has(key)) {
            ...
            // and add new node
            const node = new TreeNode(key, value, null, null);
            this.addNode(node);
